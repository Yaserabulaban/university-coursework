...
urlpatterns = [
    ...
    re_path(r'^createorderform$', orderHandling_views.createorderform, name='createorder_form'),
    re_path(r'^createorderconfirmation$', orderHandling_views.createorderconfirmation,
        name='createorder_confirmation'),
    ...
    re_path(r'^acceptdeclineorder/$', orderHandling_views.acceptdeclineorder, name='acceptdeclineorder'),
    re_path(r'^completeorcancelorder/$', orderHandling_views.completeorcancelorder, name='completeorcancelorder'),
    re_path(r'^updateorderstatus/(?P<order_id>\d+)/(?P<action>\w+)/$', orderHandling_views.updateorderstatus, name='updateorderstatus'),
