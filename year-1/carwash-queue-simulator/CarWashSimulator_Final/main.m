...
fprintf('1 - Cars go to wash bays based on service type specialization\n'); 
...
[statistics, car_Interval] = simulateCars(Number_Of_Cars, interArrival_Data, washBay1_data, washBay2_data, washBay3_data, serviceTypes_Data, rule_choice); 

% Evaluate and print the results
results = evaluateResults(statistics, car_Interval, serviceTypes_Data); 
printEvaluationResults(results, serviceTypes_Data);
