...
serviceTypes_Data = generateServiceTypesTable();
...
% Generating interarrival times and assigning cars to wash bays and service types
for count = 1:Number_Of_Cars
    ...
    switch mod(count, 3)
        case 1
            ...
            car_WashBay1 = [car_WashBay1; {count, getServiceTime(randValue, washBay1_data), car_Interval(count), serviceType}];
        case 2
            randValue = generateRandomInt(1, 100);
            car_WashBay2 = [car_WashBay2; {count, getServiceTime(randValue, washBay2_data), car_Interval(count), serviceType}];
        case 0
            randValue = generateRandomInt(1, 100);
            car_WashBay3 = [car_WashBay3; {count, getServiceTime(randValue, washBay3_data), car_Interval(count), serviceType}];
    end
end

% Debugging: Check contents of car_WashBay1, car_WashBay2, and car_WashBay3
disp('car_WashBay1:');
disp(car_WashBay1);
disp('car_WashBay2:');
disp(car_WashBay2);
