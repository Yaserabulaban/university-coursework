function [statistics, car_Interval] = simulateCars(Number_Of_Cars, interArrival_Data, washBay1_data, washBay2_data, washBay3_data, serviceTypes_Data, rule_choice)
    ...
    for count = 1:Number_Of_Cars
        ...
        statistics{bay} = [statistics{bay}; {count, randServiceType, serviceType, serviceTime, startTime, endTime, waitingTime, timeInSystem}];
    end
    ...
    % Print the statistics tables with arrival time included
    printStatisticsTables(statistics, car_Interval);

    % Evaluate and print the results
    results = evaluateResults(statistics, car_Interval);
